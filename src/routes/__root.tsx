...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Solidwall Construction Ltd — Building Your Vision" },
      {
        name: "description",
        content:
          "Solidwall Construction Ltd — trusted partner for residential, commercial & industrial construction projects. From blueprint to build.",
      },
